# In this file, I will describe the features I want to implement in the future.
- A mutual canvas like Obsidian canvas, where you can combine text and images to create a complete concept scheme without html structure.
- Choose any background color instead of a pre-made game image.
